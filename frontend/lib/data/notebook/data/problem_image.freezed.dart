...
/// Adds pattern-matching-related methods to [ProblemImage].
extension ProblemImagePatterns on ProblemImage {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ProblemImage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ProblemImage() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ProblemImage value)  $default,){
final _that = this;
switch (_that) {
case _ProblemImage():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ProblemImage value)?  $default,){
final _that = this;
switch (_that) {
case _ProblemImage() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String uid,  String originalFilename,  String filename,  String fileUrl,  String mimeType,  int fileSize,  int? width,  int? height,  int displayOrder,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProblemImage() when $default != null:
return $default(_that.id,_that.uid,_that.originalFilename,_that.filename,_that.fileUrl,_that.mimeType,_that.fileSize,_that.width,_that.height,_that.displayOrder,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String uid,  String originalFilename,  String filename,  String fileUrl,  String mimeType,  int fileSize,  int? width,  int? height,  int displayOrder,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ProblemImage():
return $default(_that.id,_that.uid,_that.originalFilename,_that.filename,_that.fileUrl,_that.mimeType,_that.fileSize,_that.width,_that.height,_that.displayOrder,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String uid,  String originalFilename,  String filename,  String fileUrl,  String mimeType,  int fileSize,  int? width,  int? height,  int displayOrder,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ProblemImage() when $default != null:
return $default(_that.id,_that.uid,_that.originalFilename,_that.filename,_that.fileUrl,_that.mimeType,_that.fileSize,_that.width,_that.height,_that.displayOrder,_that.createdAt);case _:
  return null;
