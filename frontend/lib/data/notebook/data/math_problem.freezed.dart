...
/// Adds pattern-matching-related methods to [MathProblem].
extension MathProblemPatterns on MathProblem {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MathProblem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MathProblem() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MathProblem value)  $default,){
final _that = this;
switch (_that) {
case _MathProblem():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MathProblem value)?  $default,){
final _that = this;
switch (_that) {
case _MathProblem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  DateTime updatedAt,  List<ProblemImage> images,  String? scribbleData,  List<AiFeedback> aiFeedbacks,  ProblemStatus status,  List<String> tags)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MathProblem() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.images,_that.scribbleData,_that.aiFeedbacks,_that.status,_that.tags);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  DateTime updatedAt,  List<ProblemImage> images,  String? scribbleData,  List<AiFeedback> aiFeedbacks,  ProblemStatus status,  List<String> tags)  $default,) {final _that = this;
switch (_that) {
case _MathProblem():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.images,_that.scribbleData,_that.aiFeedbacks,_that.status,_that.tags);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime createdAt,  DateTime updatedAt,  List<ProblemImage> images,  String? scribbleData,  List<AiFeedback> aiFeedbacks,  ProblemStatus status,  List<String> tags)?  $default,) {final _that = this;
switch (_that) {
case _MathProblem() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.images,_that.scribbleData,_that.aiFeedbacks,_that.status,_that.tags);case _:
  return null;
